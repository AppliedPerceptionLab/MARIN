...
#define AUGMENTATION_WIDTH 1366
#define AUGMENTATION_HEIGHT 1024
...
#define SERVER_ADDRESS "192.168.0.103"                          //Address of machine on which the neuronav platform runs
